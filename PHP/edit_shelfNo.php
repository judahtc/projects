...
if(isset($_POST['item_name'])){
		...
		$shelf_no1=mysqli_real_escape_string($db,$_POST['shelf_no1']);
		

										
										$sqli="UPDATE items SET shelf_no='$shelf_no1' where item_name='$item_name'";
				...
				<form  action="#" method="POST">
					<div style="text-align:center;margin-top:3%" class="SignInBox">
						...
						<div class="textbox">
									...
									<p><input type="text" placeholder="Enter new shelf_no" name="shelf_no1"  id="shelf_no1" size 50; required/></p>
