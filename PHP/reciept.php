...
<p><span style="float:left;margin-left:33%">To:<?php  $_POST['client_name']='client_name';echo $client_name; ?></span> <span style="float:right;margin-right:34%">Date:<?php $currentTimeinSeconds=time();
$Date=date('d-m-Y',$currentTimeinSeconds) ; 
$time=date("h:i:sa");
echo $Date;ECHO"||";echo $time; ?></span>  </p>
  ...
  if(isset($_POST["item_name"]))
{
	...
	$tatenda=("UPDATE items SET quantity=quantity-'$quantity7' where item_name='$item_name'");
$juloh=mysqli_query($db,$tatenda);
	
	
	$tatend=("UPDATE items SET quantity=quantity-'$quantity2' where item_name='$item_name2'");
$julo=mysqli_query($db,$tatend);


	$taten=("UPDATE items SET quantity=quantity-'$quantity3' where item_name='$item_name3'");
$jul=mysqli_query($db,$taten);


	$tate=("UPDATE items SET quantity=quantity-'$quantity4' where item_name='$item_name4'");
$ju=mysqli_query($db,$tate);


	$tat=("UPDATE items SET quantity=quantity-'$quantity5' where item_name='$item_name5'");
$juloh=mysqli_query($db,$tat);
...
$Date=date('d-m-Y',$currentTimeinSeconds) ; 
$time=date("h:i:sa");
$juda="INSERT INTO sales1(total,Date,time,item_name,item_name2,item_name3,item_name4,item_name5,quantity7,quantity2,quantity3,quantity4,quantity5) 
	values('$total','$Date','$time','$item_name','$item_name2','$item_name3','$item_name4','$item_name5','$quantity7','$quantity2','$quantity3','$quantity4','$quantity5')";
    mysqli_query($db,$juda);


	$judah="INSERT INTO daily_sales(total,Date,time,item_name,item_name2,item_name3,item_name4,item_name5,quantity7,quantity2,quantity3,quantity4,quantity5) 
	values('$total','$Date','$time','$item_name','$item_name2','$item_name3','$item_name4','$item_name5','$quantity7','$quantity2','$quantity3','$quantity4','$quantity5')";
$chisare=mysqli_query($db,$judah);
...
<button style="border-radius:3px;height:30px;background-color:pink;color:white" type="submit" name="print" onclick="window.print()">print</button>
