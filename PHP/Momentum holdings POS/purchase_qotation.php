...
<html lang="en" dir="ltr">
  ...
  <body style="background-color:#ffebcd">
	...
	<form method="post" action="qotation.php" target="blank">
		...
		<input style="margin-left:95px;border-bottom-color:navy" type="text" name="Date" ></p>
		<br>
		<br>
...
<option value="3">ECOCASH</option>
		...
		<button style="border-radius:3px;height:30px;background-color:green;color:white" type="submit" name="purchase" onclick="window.print()">ISSUE</button>
