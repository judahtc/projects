...
if(isset($_POST['item_name'])){
		...
		$quantity1=mysqli_real_escape_string($db,$_POST['quantity1']);
										...
										$sqli="UPDATE items SET quantity=quantity+'$quantity1' where item_name='$item_name'";
				...
				<form  action="#" method="POST">
					<div style="text-align:center;margin-top:3%" class="SignInBox">
						...
						<div class="textbox">
									...
									<p><input type="text" placeholder="Enter new quantity" name="quantity1"  id="quantity1" size 50; required/></p>
									
									
									<p><input style="color:navy" type="submit" name="submit" value="add"></p>
						</div>
				</form>	</div>	
